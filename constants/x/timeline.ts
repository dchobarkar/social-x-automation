...
export const TIMELINE_TWEET_FIELDS =
  "author_id,created_at,conversation_id,public_metrics,referenced_tweets,lang,text,note_tweet,attachments" as const;

export const TIMELINE_USER_FIELDS =
  "id,username,name,profile_image_url,public_metrics,verified" as const;
